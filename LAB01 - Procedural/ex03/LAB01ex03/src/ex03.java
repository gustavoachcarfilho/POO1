...
public class ex03 {
    ...
    public static void ex15(){
        ...
        for(cont = 0; cont < 8; cont++){
            System.out.printf("Entre com o numero %d: ", cont+1);
            vet[cont] = input.nextInt();
        }

        for(cont = 0; cont < 8; cont++){
            for(aux = cont+1; aux < 8; aux++){
                if(vet[cont] == vet[aux] && repetidos[indice] != vet[cont]){
                    indice++;
                    repetidos[indice] = vet[cont];
                }
            }
        }
        ...
        for(cont = 1; cont <= indice; cont++){
            System.out.printf("%d ", repetidos[cont]);
        }
    ...
    public static void ex16(){
        int[] vet = new int[9];
        int[] repetidos = new int[10];
        int[] local_repetidos = new int[10];
        int cont, aux, indice = 0;
        ...
        for(cont = 1; cont <= indice; cont++){
            for(aux = 0; aux < 8; aux++){
                if(repetidos[cont] == vet[aux]){
                    local_repetidos[cont]++;
                }
            }
        }
        ...
        for(cont = 1; cont <= indice; cont++){
            System.out.printf("%d aparece %d vezes\n", repetidos[cont], local_repetidos[cont]);
        }
